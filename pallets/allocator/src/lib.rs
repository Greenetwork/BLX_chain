...
// //I've created a shared trait with a balance type, added functionality to add some stuff to storage utilizing that type. I am now trying to access that shared trait from another pallet, but am running into confusion surrounding adding additional types to assist with this. Are there any examples or shared traits out there that implement
...
// 		#[weight = 10_000]
// 		fn check_balance_is_2000(origin, apn: u32) -> DispatchResult {
