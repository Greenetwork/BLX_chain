...
use sp_runtime::traits::{
	AccountIdLookup, BlakeTwo256, Block as BlockT, Verify, IdentifyAccount, NumberFor, Saturating,
...
impl claimer::Config for Runtime {
...
impl loose_lookup::Config for Runtime {
	// type Event = Event;
	type Lookie = Claimer;
	type AccountIndex = AccountIndex;
	type Currency = Balances;
